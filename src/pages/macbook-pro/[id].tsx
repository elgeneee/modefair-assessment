        ...
        {!isProductPage ? (
          <div className="w-full px-6">
            <div className="mx-auto max-w-7xl flex-col justify-center text-center">
              ...
              <div className="mt-20">
                <p className="pb-10 pt-11 text-4xl font-semibold">
                  What&apos;s in the Box
                </p>
                <ul className="flex w-full justify-around text-sm">
                  <li className="text-center">
                    <div className="relative flex h-[392px] justify-between bg-[#fafafa]">
                      <img
              ...
              <div className="mt-24 rounded-lg bg-[#FAFAFA] p-10">
                ...
                <div className="mt-14 grid grid-cols-1 gap-4 font-light md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="mx-auto mt-20 max-w-7xl text-center">
              ...
              <p className="mt-3 text-left font-light">
                ...
                AppleCare+ for Mac extends your coverage to three years from
                your AppleCare+ purchase date and adds unlimited incidents of
                accidental damage protection, each subject to a service fee of
                RM 469 for screen damage or external enclosure damage, or RM
                1,429 for other accidental damage. In addition, you‘ll get 24/7
                priority access to Apple experts by chat or phone through{" "}
                <span className="text-[#06C] underline">
            ...
            <div className="mx-auto flex max-w-7xl justify-center px-6">
              ...
              <div className="ml-10 w-1/2 text-sm font-light">
                ...
                <div className="space-y-3 pb-10 pt-3">
                  ...
                  <p>
                    Backlit Magic Keyboard with Touch ID - {selectedKeyboard}
                  </p>
                </div>
                <hr />
